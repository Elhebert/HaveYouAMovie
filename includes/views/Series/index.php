<?php
    ...
    if(isset($r['params']['1']) && $r['params']['1'] == 'true')
        echo '<div data-alert class="alert-box success">Une série vient d\'être ajoutée à votre base de donnée !<a href="#" class="close">&times;</a></div>';

    echo '<h3>Liste des séries :</h3>';

    $data = rechercherToutesLesSeries($db);
